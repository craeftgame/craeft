    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <span>{this.props.boss.name}</span> vs. <span>{craeft.player.name}</span>
                </div>
                    ...
                    <div className="columns nowrap">
                        ...
                        <div className="column">
                            <span className="icon fight-item left">
                                <i className={`fas fa-${this.props.boss.type} fa-2x`}/>
                            </span>
                        </div>
                        ...
                        <div className="column">
                            <div className="fight-item right">
                                <ItemIconIcon item={craeft.player.equipment[WeaponSlots.RightHand]}
                                              isSmall={true}/>
                            </div>
                        </div>
