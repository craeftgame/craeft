            ...
            <div className="rpgui-container framed-grey">
                <div className="rpgui-center nowrap map-wrap">
                    ...
                    <div className="control">
                        <div className="controls left" onClick={() => this.props.onMove("left")}>
                            <div className="icon">
                                <i className="rpgui-cursor-point fas fa-caret-left fa-2x"/>
                            </div>
                        </div>
                        <div className="controls up" onClick={() => this.props.onMove("up")}>
                            <div className="icon">
                                <i className="rpgui-cursor-point fas fa-caret-up fa-2x"/>
                            </div>
                        </div>
                        <div className="controls right" onClick={() => this.props.onMove("right")}>
                            <div className="icon">
                                <i className="rpgui-cursor-point fas fa-caret-right fa-2x"/>
                            </div>
                        </div>
                        <div className="controls down" onClick={() => this.props.onMove("down")}>
                            <div className="icon">
